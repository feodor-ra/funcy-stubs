...
@overload
def repeatedly(f: Callable[[], T], /) -> Iterable[T]: ...
@overload
def repeatedly(f: Callable[[], T], n: int) -> Iterable[T]: ...
...
@overload
def map(f: Callable[[T1], S], iter1: Iterable[T1], /) -> Iterable[S]: ...
@overload
def map(
    f: Callable[[T1, T2], S],
    iter1: Iterable[T1],
...
@overload
def map(f: None, iter1: Iterable[T1], /) -> Iterable[T1]: ...
@overload
def map(
    f: RegexType[AnyStr],
    iter1: Iterable[str],
    /,
) -> Iterable[MatchType[AnyStr] | None]: ...
@overload
def map(f: int, iter1: Iterable[Sequence[T1]], /) -> Iterable[T1]: ...
@overload
def map(f: slice, iter1: Iterable[Sequence[T1]], /) -> Iterable[Sequence[T1]]: ...
@overload
def map(f: Mapping[KT, VT], iter1: Iterable[KT], /) -> Iterable[VT]: ...
@overload
def map(f: set[H], iter1: Iterable[H], /) -> Iterable[bool]: ...
@overload
...
@overload
def filter(pred: Callable[[T], Boolean[B]], seq: Iterable[T]) -> Iterable[T]: ...
@overload
def filter(pred: None, seq: Iterable[T]) -> Iterable[T]: ...
@overload
def filter(pred: RegexType[AnyStr], seq: Iterable[str]) -> Iterable[str]: ...
@overload
def filter(pred: int, seq: Iterable[Sequence[T]]) -> Iterable[Sequence[T]]: ...
@overload
def filter(pred: slice, seq: Iterable[Sequence[T]]) -> Iterable[Sequence[T]]: ...
@overload
def filter(pred: Mapping[KT, VT], seq: Iterable[KT]) -> Iterable[KT]: ...
@overload
def filter(pred: set[H], seq: Iterable[H]) -> Iterable[H]: ...
@overload
...
@overload
def remove(pred: Callable[[T], Boolean[B]], seq: Iterable[T]) -> Iterable[T]: ...
@overload
def remove(pred: None, seq: Iterable[T]) -> Iterable[T]: ...
@overload
def remove(pred: RegexType[AnyStr], seq: Iterable[str]) -> Iterable[str]: ...
@overload
def remove(pred: int, seq: Iterable[Sequence[T]]) -> Iterable[Sequence[T]]: ...
@overload
def remove(pred: slice, seq: Iterable[Sequence[T]]) -> Iterable[Sequence[T]]: ...
@overload
def remove(pred: Mapping[KT, VT], seq: Iterable[KT]) -> Iterable[KT]: ...
@overload
def remove(pred: set[H], seq: Iterable[H]) -> Iterable[H]: ...
@overload
...
@overload
def keep(f: Iterable[T]) -> Iterable[T]: ...
@overload
def keep(f: Callable[[T], Boolean[B]], seq: Iterable[T]) -> Iterable[T]: ...
@overload
def keep(f: None, seq: Iterable[T]) -> Iterable[T]: ...
@overload
def keep(
    f: RegexType[AnyStr],
    seq: Iterable[str],
...
@overload
def keep(f: int, seq: Iterable[Sequence[T]]) -> Iterable[T]: ...
@overload
def keep(f: slice, seq: Iterable[Sequence[T]]) -> Iterable[Sequence[T]]: ...
@overload
def keep(f: Mapping[KT, VT], seq: Iterable[KT]) -> Iterable[VT]: ...
@overload
def keep(f: set[H], seq: Iterable[H]) -> Iterable[bool]: ...
def without(seq: Iterable[T], *items: T) -> Iterable[T]: ...
def lwithout(seq: Iterable[T], *items: T) -> list[T]: ...
def lconcat(*seqs: Iterable[T]) -> list[T]: ...
def concat(*seqs: Iterable[T]) -> Iterable[T]: ...
def lcat(seqs: Iterable[Iterable[T]]) -> list[T]: ...
def cat(seqs: Iterable[Iterable[T]]) -> Iterable[T]: ...
def flatten(
    seq: Iterable[T],
...
@overload
def mapcat(f: None, iter1: Iterable[Iterable[T1]], /) -> Iterable[T1]: ...
@overload
def mapcat(
    f: RegexType[AnyStr],
    iter1: Iterable[str],
...
@overload
def mapcat(f: int, iter1: Iterable[Sequence[T1]], /) -> Iterable[T1]: ...
@overload
def mapcat(f: slice, iter1: Iterable[Sequence[T1]], /) -> Iterable[T1]: ...
@overload
def mapcat(f: Mapping[KT, VT], iter1: Iterable[KT], /) -> Iterable[VT]: ...
@overload
def mapcat(f: set[H], iter1: Iterable[H], /) -> Iterable[bool]: ...
@overload
def interleave(
    iter1: Iterable[T1],
    /,
...
@overload
def takewhile(seq: Iterable[T], /) -> Iterable[T]: ...
@overload
def takewhile(pred: Callable[[T], Boolean[B]], seq: Iterable[T]) -> Iterable[T]: ...
@overload
def takewhile(pred: None, seq: Iterable[T]) -> Iterable[T]: ...
@overload
def takewhile(pred: RegexType[AnyStr], seq: Iterable[str]) -> Iterable[str]: ...
@overload
def takewhile(pred: int, seq: Iterable[Sequence[T]]) -> Iterable[Sequence[T]]: ...
@overload
def takewhile(pred: slice, seq: Iterable[Sequence[T]]) -> Iterable[Sequence[T]]: ...
@overload
def takewhile(pred: Mapping[KT, VT], seq: Iterable[KT]) -> Iterable[KT]: ...
@overload
def takewhile(pred: set[H], seq: Iterable[H]) -> Iterable[H]: ...
@overload
def dropwhile(seq: Iterable[T], /) -> Iterable[T]: ...
@overload
def dropwhile(pred: Callable[[T], Boolean[B]], seq: Iterable[T]) -> Iterable[T]: ...
@overload
def dropwhile(pred: None, seq: Iterable[T]) -> Iterable[T]: ...
@overload
def dropwhile(pred: RegexType[AnyStr], seq: Iterable[str]) -> Iterable[str]: ...
@overload
def dropwhile(pred: int, seq: Iterable[Sequence[T]]) -> Iterable[Sequence[T]]: ...
@overload
def dropwhile(pred: slice, seq: Iterable[Sequence[T]]) -> Iterable[Sequence[T]]: ...
@overload
def dropwhile(pred: Mapping[KT, VT], seq: Iterable[KT]) -> Iterable[KT]: ...
@overload
def dropwhile(pred: set[H], seq: Iterable[H]) -> Iterable[H]: ...
@overload
def ldistinct(seq: Iterable[H], /) -> list[H]: ...
@overload
def ldistinct(seq: Iterable[T], key: Callable[[T], H]) -> list[T]: ...
@overload
...
@overload
def distinct(seq: Iterable[H], /) -> Iterable[H]: ...
@overload
def distinct(seq: Iterable[T], key: Callable[[T], H]) -> Iterable[T]: ...
@overload
def distinct(seq: Iterable[T], key: None) -> Iterable[T]: ...
@overload
def distinct(seq: Iterable[str], key: RegexType[AnyStr]) -> Iterable[str]: ...
@overload
def distinct(seq: Iterable[Sequence[KT]], key: int) -> Iterable[KT]: ...
@overload
def distinct(seq: Iterable[tuple[KT, ...]], key: slice) -> Iterable[tuple[KT, ...]]: ...
@overload
def distinct(seq: Iterable[KT], key: Mapping[KT, H]) -> Iterable[KT]: ...
@overload
def distinct(seq: Iterable[H], key: set[H]) -> Iterable[H]: ...
@overload
def split(
...
@overload
def split(pred: None, seq: Iterable[T]) -> tuple[Iterable[T], Iterable[T]]: ...
@overload
def split(
...
@overload
def split(pred: int, seq: Iterable[Sequence[T]]) -> tuple[Iterable[T], Iterable[T]]: ...
@overload
def split(
    pred: slice,
    seq: Iterable[Sequence[T]],
) -> tuple[Iterable[Sequence[T]], Iterable[Sequence[T]]]: ...
@overload
def split(
    pred: Mapping[KT, bool],
    seq: Iterable[KT],
) -> tuple[Iterable[KT], Iterable[KT]]: ...
@overload
def split(pred: set[H], seq: Iterable[H]) -> tuple[Iterable[H], Iterable[H]]: ...
@overload
...
def split_at(n: int, seq: Iterable[T]) -> tuple[Iterable[T], Iterable[T]]: ...
def lsplit_at(n: int, seq: Iterable[T]) -> tuple[list[T], list[T]]: ...
@overload
def split_by(
    pred: Callable[[T], bool],
    seq: Iterable[T],
...
@overload
def split_by(pred: None, seq: Iterable[T]) -> tuple[Iterable[T], Iterable[T]]: ...
@overload
def split_by(
    pred: RegexType[AnyStr],
    seq: Iterable[str],
...
@overload
def split_by(pred: set[H], seq: Iterable[H]) -> tuple[Iterable[H], Iterable[H]]: ...
@overload
def lsplit_by(
    pred: Callable[[T], bool],
    seq: Iterable[T],
...
@overload
def partition(n: int, seq: Iterable[T], /) -> Iterable[list[T]]: ...
@overload
def partition(n: int, step: int, seq: Iterable[T]) -> Iterable[list[T]]: ...
@overload
def lpartition(n: int, seq: Iterable[T], /) -> list[list[T]]: ...
@overload
def lpartition(n: int, step: int, seq: Iterable[T]) -> list[list[T]]: ...
@overload
def chunks(n: int, seq: Iterable[T], /) -> Iterable[list[T]]: ...
@overload
def chunks(n: int, step: int, seq: Iterable[T]) -> Iterable[list[T]]: ...
@overload
def lchunks(n: int, seq: Iterable[T], /) -> list[list[T]]: ...
@overload
def lchunks(n: int, step: int, seq: Iterable[T]) -> list[list[T]]: ...
@overload
def partition_by(f: Callable[[T], KT], seq: Iterable[T]) -> Iterable[list[T]]: ...
@overload
def partition_by(f: None, seq: Iterable[KT]) -> Iterable[list[KT]]: ...
@overload
def partition_by(f: RegexType[AnyStr], seq: Iterable[str]) -> Iterable[list[str]]: ...
@overload
def partition_by(
    f: int,
    seq: Iterable[Sequence[KT]],
) -> Iterable[list[Sequence[KT]]]: ...
@overload
def partition_by(
    f: slice,
    seq: Iterable[tuple[H, ...]],
) -> Iterable[list[tuple[H, ...]]]: ...
@overload
def partition_by(f: Mapping[KT, H], seq: Iterable[KT]) -> Iterable[list[KT]]: ...
@overload
def partition_by(f: set[H], seq: Iterable[H]) -> Iterable[list[H]]: ...
@overload
...
@overload
def with_prev(seq: Iterable[T1]) -> Iterable[tuple[T1, T1 | None]]: ...
@overload
def with_prev(seq: Iterable[T1], fill: T2) -> Iterable[tuple[T1, T1 | T2]]: ...
@overload
def with_next(seq: Iterable[T1]) -> Iterable[tuple[T1, T1 | None]]: ...
@overload
def with_next(seq: Iterable[T1], fill: T2) -> Iterable[tuple[T1, T1 | T2]]: ...
...
@overload
def reductions(f: Callable[[S, T], S], seq: Iterable[T]) -> Iterable[S]: ...
@overload
def reductions(f: Callable[[S, T], S], seq: Iterable[T], acc: S) -> Iterable[S]: ...
@overload
def lreductions(f: Callable[[S, T], S], seq: Iterable[T]) -> list[S]: ...
@overload
def lreductions(f: Callable[[S, T], S], seq: Iterable[T], acc: S) -> list[S]: ...
def sums(seq: Iterable[SupportsAdd[T]], acc: T = ...) -> Iterable[T]: ...
