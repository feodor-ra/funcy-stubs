...
@overload
def lfilter(pred: Callable[[_T], object], seq: Iterable[_T]) -> list[_T]: ...
@overload
...
@overload
def filter(pred: Callable[[_T], object], seq: Iterable[_T]) -> Iterable[_T]: ...
@overload
...
@overload
def lremove(pred: Callable[[_T], object], seq: Iterable[_T]) -> list[_T]: ...
@overload
...
@overload
def remove(pred: Callable[[_T], object], seq: Iterable[_T]) -> Iterable[_T]: ...
@overload
...
@overload
def lkeep(f: Callable[[_T], object], seq: Iterable[_T]) -> list[_T]: ...
@overload
...
@overload
def keep(f: Callable[[_T], object], seq: Iterable[_T]) -> Iterable[_T]: ...
@overload
...
def flatten(
    seq: Iterable[_T],
    follow: Callable[[_T], object] = ...,
) -> Iterable[_T]: ...
def lflatten(seq: Iterable[_T], follow: Callable[[_T], object] = ...) -> list[_T]: ...
@overload
def lmapcat(
...
@overload
def takewhile(pred: Callable[[_T], object], seq: Iterable[_T]) -> Iterable[_T]: ...
@overload
...
@overload
def dropwhile(pred: Callable[[_T], object], seq: Iterable[_T]) -> Iterable[_T]: ...
@overload
